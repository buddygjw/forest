 ...
 */
package com.dempe.forest.mqtt.spi.impl;


import com.dempe.forest.mqtt.server.ConnectionDescriptor;
import com.dempe.forest.mqtt.server.netty.NettyUtils;
import com.dempe.forest.mqtt.spi.ClientSession;
import com.dempe.forest.mqtt.spi.IMatchingCondition;
import com.dempe.forest.mqtt.spi.IMessagesStore;
import com.dempe.forest.mqtt.spi.ISessionsStore;
import com.dempe.forest.mqtt.spi.impl.subscriptions.Subscription;
import com.dempe.forest.mqtt.spi.impl.subscriptions.SubscriptionsStore;
import com.dempe.forest.mqtt.spi.security.IAuthenticator;
import com.dempe.forest.mqtt.spi.security.IAuthorizator;
...
//        if (msg.getProtocolVersion() != Utils.VERSION_3_1 && msg.getProtocolVersion() != VERSION_3_1_1) {
...
//        LOG.info("CONNECT clients descriptors {}", m_clientIDs);
    ...
    private boolean subscribeSingleTopic(final Subscription newSubscription) {
        ...
        for (IMessagesStore.StoredMessage storedMsg : messages) {
            ...
            Integer packetID = storedMsg.getQos() == AbstractMessage.QOSType.MOST_ONE ? null :
