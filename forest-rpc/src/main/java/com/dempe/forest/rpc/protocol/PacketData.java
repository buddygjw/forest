...
public class PacketData {
    ...
    public PacketData logId(long logId) {
        RequestMeta request = initRequest();
    ...
    public static PacketData buildRpcDataPackage(RpcMethodInfo methodInfo, Object[] args) throws IOException {
        PacketData dataPackage = new PacketData();
