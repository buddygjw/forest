package com.dempe.forest.common.register;
 ...
 */
public class ForestNameClient implements Closeable {
    private final ServiceDiscovery<NodeDetails> serviceDiscovery;
    private final ServiceInstance<NodeDetails> thisInstance;

    public ForestNameClient(CuratorFramework client, String path, NodeDetails nodeDetails) throws Exception {
