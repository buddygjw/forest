package com.dempe.forest.common.cluster.accessctr;
...
//	{
//		FilterInfo filterInfo = addHit(targetKey);
...
//				return true;
//			}else{
//				if(timeInterval >= this.getRecyleInterval()*1000){ //看时间如果到了重置时长，则清空统计目标重试一次
//					removeTargetKey(targetKey);
//					return true;
//				}else{
//					return false;
    ...
    public void removeExpireFilterInfo() {
        try {
            ...
            while (inter.hasNext()) {
                ...
                FilterInfo value = (FilterInfo) filterInfoMap.get(key);
                if (null == value) {
                    continue;
                }
